...
<div class="worker-form">
    ...
    <?= $form->field($model, 'employee_id')->dropDownList($workerItems,$workerParams)->label('Hodim Fio',['class'=>'tc']) ?>
    
    <?= $form->field($model, 'order_id')->dropDownList($orderItems,$orderParams)->label('Buyurtma №',['class'=>'tc']) ?>
    
    <?= $form->field($model, 'code_id')->dropDownList($codeItems,$codeParams)->label('Operatsiya turi',['class'=>'tc']) ?>
