...
<div class="worker-form">
    ...
    <?= $form->field($model, 'order_id', ['inputOptions'=>['class' =>'form-control', 'tabindex'=>'1']])->dropDownList(ArrayHelper::map(Orders::find()->orderBy('id DESC')->limit(5000)->all(),'id','id'),
        [
            'prompt'  => 'Buyurtma tanlang....',
            'onchange'=> '
